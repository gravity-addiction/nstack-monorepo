...
export interface ISquareupTender {
...
export interface ISquareupTenderCashDetails { // Represents additional details of a tender with type CARD or SQUARE_GIFT_CARD
...
export interface ISquareupTenderCardDetails { // Represents additional details of a tender with type CARD or SQUARE_GIFT_CARD
